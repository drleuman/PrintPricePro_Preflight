...
async function patchSchema() {
    ...
    const patches = [
        ...
        { table: 'routing_history', column: 'id', query: "CREATE TABLE IF NOT EXISTS routing_history (id VARCHAR(36) PRIMARY KEY, job_id VARCHAR(36), printer_id VARCHAR(36), routing_score FLOAT, compatibility_score FLOAT, quality_score FLOAT, capacity_score FLOAT, price_score FLOAT, distance_score FLOAT, selected BOOLEAN DEFAULT SERIAL_FALSE, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (printer_id) REFERENCES printer_nodes(id) ON DELETE CASCADE)" },
