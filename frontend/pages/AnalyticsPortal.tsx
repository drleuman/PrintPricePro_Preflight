                            ...
                            <div className="space-y-3">
                                {policies.map(p => (
                                    <div key={p.policy_slug} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
                                        <div>
                                            <p className="font-semibold text-sm text-slate-800">{formatLabel(p.policy_slug)}</p>
                                ...
                                {errors.map((e, i) => (
                                    <div key={i} className="flex items-center gap-3 py-2 border-b border-slate-50 last:border-0">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-xs font-mono text-slate-700 truncate">{formatLabel(e.error_message)}</p>
