export const en = {
  ...
  rebuildHighRes300dpi: '🔍 Rebuild at 300 DPI (review/diagnostic only)',
  ...
  rebuildPdfHighRes: 'Rebuild PDF at 300 DPI (diagnostic preview — not a quality upgrade)',
  ...
  bestWithAi: 'Best with Magic Fix',
  ...
  headerUploadSubset: 'Choose Magic Fix (recommended) or Manual.',
  ...
  'account.autoMagicFix': 'Automated Preflight Magic Fix',
  ...
  'step.fix.magic': 'MAGIC FIX IN PROGRESS',
  ...
  'step.review.rebuild300': 'Rebuild 300 DPI (diagnostic preview only)',
  'step.review.rebuild300.notice': 'This does not restore real image quality. Please reupload a higher-resolution source file if print quality is insufficient. Use this output for review/diagnostic purposes only.',
  ...
  'autofix.rebuild': '300 DPI rebuild (diagnostic only — not a real quality restoration)',
  'autofix.flatten': 'Flatten Transp.',
  'autofix.magicProgress': 'Magic in progress...',
  'autofix.startMagic': 'Start Magic Fix',
  ...
  'loader.magic': 'Initializing Magic Fix on OS...',
  'loader.downloading': 'Downloading secure artifact...',
  ...
  'inspector.findingDetails': 'Finding Details',
  'inspector.engineRecommendation': 'Engine Recommendation',
  'inspector.technicalContext': 'Technical Context',
  'inspector.fixable': 'Fixable:',
  'inspector.deepDiagnostic': 'Deep Diagnostic',
  'inspector.efficiencyLab': 'Efficiency Lab',
  'inspector.efficiencyProtocol': 'Efficiency Protocol Analysis',
  'inspector.consultingAi': 'Consulting AI Knowledge Base...',
  'inspector.resetProtocol': 'Reset Protocol',
  'inspector.applyBleedFix': 'Apply 3mm Standard Fix',
  'inspector.applyCmykFix': 'Convert to CMYK Policy',
  'inspector.fixIssue': 'Fix this issue',
  'inspector.systemLoad': 'System Load',
  'inspector.dismiss': 'Dismiss',
  'inspector.isFixableYes': 'YES',
  'inspector.isFixableNo': 'NO',
  'inspector.pageLabelDoc': 'DOCUMENT',
  'inspector.pageLabelPage': 'PAGE',
  ...
  'app.confirmLeave': 'Work in progress. Are you sure you want to leave?',
  'app.error.noCertified': 'No certified PDF available for download yet. Ensure analysis is complete.',
  'app.error.noSource': 'No downloadable source found for this career.',
  'app.error.retrievalFailed': 'Secure artifact retrieval failed. The server session might have expired or the link is stale.',
  'step.analysis.terminal.enqueuing': 'ENQUEUING V2 ASYNC JOB...',
  'step.analysis.terminal.scanning': 'SCANNING CARRIER SEGMENTS...',
  'step.analysis.terminal.heuristic': 'HEURISTIC ENGINE PROBING...',
  'step.analysis.terminal.deterministic': 'DETERMINISTIC VALIDATION...',
  'step.analysis.terminal.finalizing': 'FINALIZING FORENSIC TRACE...',
  'step.analysis.zeroIssues.title': '0 issues found',
  'step.analysis.zeroIssues.desc': 'Your file is perfectly compliant with the selected policy.',
  'step.analysis.failed.title': 'Analysis failed',
  'step.analysis.failed.desc': 'The engine encountered a problem while inspecting the carrier.',
  'step.fix.terminal.enqueuing': 'ENQUEUING_ENGINE_JOB...',
  'step.fix.terminal.radiological': 'CORE_RADIOLOGICAL_CORRECTION...',
  'step.fix.terminal.heuristic': 'HEURISTIC_LAYOUT_NORMALIZATION...',
  'step.fix.terminal.rebuilding': 'REBUILDING_COMPLIANT_ARTIFACT...',
  'step.fix.failed.title': 'Fix failed',
  'step.fix.failed': 'Fix failed',
  'step.fix.engineTerminal': 'Terminal Engine Error',
  'step.fix.failureNotice': 'The PPOS engine encountered a transient failure during trace hardening. Manual review is recommended.',
  'step.fix.calculatingInk': 'CALCULATING_INK_DENSITY...',
  'step.review.terminal.handshake': 'INITIATING_ENGINE_HANDSHAKE_V2',
  'step.review.terminal.intents': 'ENFORCING_ISO_OUTPUT_INTENTS',
  'step.review.terminal.optimizing': 'OPTIMIZING_COLOR_CARRIER_RESPONSE',
  'step.review.terminal.hardening': 'HARDENING_PDF_STRUCTURES',
  'step.review.terminal.sealing': 'SEALING_CERTIFIED_ARTIFACT_INTEGRITY',
  'step.review.banners.compliantTitle': 'Document already compliant',
  'step.review.banners.compliantDesc': 'Your PDF already meets the selected print policy. No technical corrections were required to ensure compliance.',
  'step.review.banners.fixedTitle': 'Fixes applied successfully',
  'step.review.banners.fixedDesc': 'Multiple issues were detected and corrected to meet ISO standards. You can now compare the changes below.',
  'step.review.banners.analysisComplete': 'Analysis complete',
  'step.review.banners.criticalFindings': 'Critical findings were detected in your document profile. Review the certification panel for details.',
  'step.review.banners.noIssues': 'No issues were detected. Your document is fully compliant with the target profile.',
  'step.review.sideBySide': 'SIDE-BY-SIDE',
  'step.review.singleView': 'SINGLE VIEW',
  'step.review.originalDoc': 'Original Document',
  'step.review.fixedPdf': 'Fixed PDF',
  'step.review.optimizedPrint': 'Optimized for Print',
  'step.review.downloadCertified': 'Download certified PDF',
  'step.review.downloadFixed': 'Download fixed PDF',
  'step.review.downloadReport': 'Download report PDF',
  'step.review.exportJson': 'Export Analysis Report (JSON)',
  'step.review.ingressState': 'Ingress State',
  'step.review.fixedEffective': 'Fixed (Effective)',
  'step.download.exportJson': 'Export Technical Analysis Report (JSON)',
  'error.engineTerminated': 'ENGINE TERMINATED',
  'error.errorCode': 'Error Code',
  'error.traceId': 'Trace ID',
  'error.reportTrace': 'Report this trace to PPOS Operations if the problem persists.',
  'error.acknowledgeClose': 'Acknowledge & Close',
  'app.analyzeCarrier': 'Analyze_Carrier',
  'systemTerminalError': 'System_Terminal_Error',
  'common.workInProgress': 'Work in progress. Are you sure you want to leave?',
  'step.review.analyzeCarrier': 'Analyze Carrier',
